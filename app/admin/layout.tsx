...
export default function AdminLayout({
	...
	return (
		<div className="bg-admin-gray-thin relative">
			<Header />
			<div className="flex">
				<section className="bg-white sticky left-0 top-0 flex h-screen w-fit overflow-y-auto border-r border-r-admin-gray-dark border-opacity-40 p-6 pt-36 shadow-light-300 lg:w-[266px]">
