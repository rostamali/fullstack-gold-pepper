...
const ProjectForm: React.FC<ProjectForm> = ({
	...
	return (
		<Form {...form}>
			...
			>
				<div className="grid lg:grid-cols-12 grid-cols-1 lg:gap-[40px] gap-[25px]">
					<div className="lg:col-span-8 admin-form__space">
						...
						{/* Min Invest Amount - Capex Required - Total Revenue - Total Cost - ROI - Target Amount */}
						...
						<FormField
							...
							render={({ field }) => (
								<FormItem>
									...
									<FormControl>
										<Textarea
											className="input-field-md !h-[314px]"
											{...field}
										/>
									</FormControl>
									<FormMessage className="form__error" />
					...
					<FormField
						...
						render={({ field }) => (
							<FormItem>
								...
								<FormControl>
									<GallerySelect
										fileHeightClass="h-[200px]"
										containerClass="grid grid-cols-4 gap-[20px]"
										onFileChange={(val) => {
				...
				{/* Documents */}
				<div className="project-documents bg-white p-[20px] border border-admin-gray-dark border-opacity-80 rounded-md">
					<div className="flex items-center justify-between gap-[15px]">
						...
						<button
							...
							type="button"
							onClick={() => addDocumentFields(fields.length)}
						>
							<FiPlus />
							<span>Add File</span>
						</button>
					...
					<div className="documents">
						{fields.map((field, index) => (
							<Documents
								key={index}
								title={form.watch(`documents.${index}.name`)}
								fields={
